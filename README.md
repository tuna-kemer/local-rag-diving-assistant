...
📄 **[Read the full project report (PDF)](DiveBuddy_Final_Report.pdf)** — motivation, concepts learned, development process, challenges, and example interactions.
...
│   ├── chat_example_1.png         Example chat interaction
│   └── chat_example_2.png         Example chat interaction
├── static/
...
├── DiveBuddy_Final_Report.pdf     Full project report
